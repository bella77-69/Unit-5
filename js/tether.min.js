!(function (t, e) {
  ...
  function o(t) {
    ...
    for (var n = t; (n = n.parentNode) && n && 1 === n.nodeType; ) {
      ...
      var a = r,
        ...
        l = a.overflowX,
        h = a.overflowY;
      /(auto|scroll|overlay)/.test(f + h + l) &&
        ("absolute" !== o ||
  ...
  function n(t) {
    var o = void 0;
    t === document
      ? ((o = document), (t = document.documentElement))
      : (o = t.ownerDocument);
        ...
        !(function () {
          ...
          I.forEach(function (t, o) {
            (t = t[0].toUpperCase() + t.substr(1)),
              "Top" === t || "Left" === t
                ? (e[o] += parseFloat(r["border" + t + "Width"]))
                : (e[o] -= parseFloat(r["border" + t + "Width"]));
          });
        })(),
      e
                ...
                S(function () {
                  "undefined" != typeof o._addAttachClasses &&
                    ...
                    o.options.addTargetClasses !== !1 &&
                      p(o.target, o._addAttachClasses, r),
              ...
              if (this.enabled) {
                ...
                return (
                  ...
                  (["", "static"].indexOf(A.body.style.position) !== -1 &&
                    ...
                    ((x.page.bottom = A.body.scrollHeight - b - f),
                  ...
                  "undefined" != typeof this.options.optimizations &&
                    ...
                    !(function () {
                      ...
                      if (
                        ...
                        (o.right =
                          A.body.scrollWidth - o.left - s.width + a.right),
                        (o.bottom =
                          A.body.scrollHeight - o.top - s.height + a.bottom),
      ...
      return (
        this.options.constraints.forEach(function (t) {
          ...
          ("target" !== d && "both" !== d) ||
            ...
            o + f > w[3] && "bottom" === v.top && ((o -= u), (v.top = "top"))),
            "together" === d &&
              ("top" === v.top &&
                ("bottom" === y.top && o < w[1]
                  ...
                  : "top" === y.top &&
                    o + f > w[3] &&
                    o - (f - u) >= w[1] &&
                    ((o -= f - u), (v.top = "bottom"), (y.top = "bottom"))),
              "bottom" === v.top &&
                ("top" === y.top && o + f > w[3]
              ...
              "middle" === v.top &&
                (o + f > w[3] && "top" === y.top
                  ...
                  : o < w[1] &&
                    ...
                    ((o += f), (y.top = "top")))),
            ("target" !== h && "both" !== h) ||
              (i < w[0] && "left" === v.left && ((i += c), (v.left = "right")),
              i + l > w[2] &&
                "right" === v.left &&
                ((i -= c), (v.left = "left"))),
            "together" === h &&
              (i < w[0] && "left" === v.left
                ? "right" === y.left
                  ...
                  : "left" === y.left &&
                    ((i += c), (v.left = "right"), (i -= l), (y.left = "right"))
                : i + l > w[2] && "right" === v.left
                ? "left" === y.left
                  ? ((i -= c), (v.left = "left"), (i -= l), (y.left = "right"))
                  : "right" === y.left &&
                    ((i -= c), (v.left = "left"), (i += l), (y.left = "left"))
                : "center" === v.left &&
                  (i + l > w[2] && "left" === y.left
                    ? ((i -= l), (y.left = "right"))
                    : i < w[0] &&
                      ...
                      ((i += l), (y.left = "left")))),
            ("element" !== d && "both" !== d) ||
              (o < w[1] && "bottom" === y.top && ((o += f), (y.top = "top")),
              o + f > w[3] &&
                "top" === y.top &&
                ((o -= f), (y.top = "bottom"))),
            ("element" !== h && "both" !== h) ||
